...
frac_list = [1] if args.method == 'full' else [0.1, 0.3, 0.5, 0.7]
...
for frac in frac_list:
    for prob in prob_list:
        ...
        #print (features.shape[1], num_classes)
        ...
        optimizer = torch.optim.SGD(model.parameters(), lr=0.01,weight_decay=0.0003)
